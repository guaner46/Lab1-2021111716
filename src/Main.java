...
public final class Main {
    ...
    public static void main(final String[] args) {
        ...
        // 生成新文本
        while (true) {
            System.out.println("Generate new text according "
                    +
                    "to bridge words list?(y or n):");
        ...
        while (true) {
            ...
            if (Objects.equals(isCalcShortestPath, "y")) {
                System.out.println("Please input word1:");
                String word1 = inScanner.nextLine();
                System.out.println("Plaese input word2"
                        +
                        "(If you don't have word2, just press ENTER):");
                String word2 = inScanner.nextLine();
